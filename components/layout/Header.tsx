            ...
            <div className="flex items-center gap-4 flex-1">
                ...
                <div className="flex items-center gap-3 mr-2 shrink-0">
                    <div className="w-9 h-9 rounded-xl overflow-hidden flex items-center justify-center">
                        <img
                            src={brand?.logo_url || '/HR360_Logo.png'}
                            className="w-full h-full object-contain"
                            alt={`${brand?.company_name || 'HR360'} Logo`}
                        />
                    </div>
                    <span
                        className="text-sm font-black tracking-tight uppercase italic hidden lg:block"
                        style={{ color: brand?.primary_color || 'inherit' }}
                    >
                ...
                <div className="relative flex-1 max-w-lg hidden sm:block">
                    ...
                    <input
                        ...
                        className="w-full bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-2xl py-2.5 pl-12 pr-4 text-xs text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-purple-500/20 transition-all"
                    />
                </div>
