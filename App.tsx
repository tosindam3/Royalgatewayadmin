...
const SIDEBAR_CONFIG = [
  ...
  { label: 'Attendance', icon: <ICONS.Attendance />, route: '/attendance', roles: [UserRole.SUPER_ADMIN, UserRole.ADMIN, UserRole.MANAGER], permissions: ['attendance.view'] },
  ...
  { label: 'My Attendance', icon: <ICONS.Attendance />, route: '/me/attendance' },
