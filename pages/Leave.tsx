      ...
      <div className="animate-in slide-in-from-bottom-2 duration-500">
                  ...
                  <div className="space-y-4">
                    {requestsLoading ? (
                      ...
                      pendingRequests.map((req) => (
                        <div
                          key={req.id}
                          className="p-3 bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/5 rounded-2xl flex items-center justify-between"
                        >
                          <div className="flex items-center gap-3">
        ...
        {activeTab === 'Leave Requests' && (
          <GlassCard className="!p-0 overflow-hidden">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left">
                <thead>
                  <tr className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest border-b border-slate-200 dark:border-white/5 bg-slate-50 dark:bg-white/[0.01]">
                  ...
                  {requestsLoading ? (
                    ...
                    requests.map((req) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 text-xs text-slate-500 dark:text-slate-400 font-mono tracking-tighter">
              ...
              <div className="p-4 border-t border-slate-200 dark:border-white/5 flex justify-between items-center">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="px-3 py-1 bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded text-[10px] font-bold text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white disabled:opacity-50"
                  >
                    Previous
                  </button>
                  <span className="px-3 py-1 text-[10px] font-bold text-slate-900 dark:text-white">
                    Page {currentPage} of {requestsMeta.last_page}
                  </span>
                  <button
                    onClick={() => setCurrentPage((p: number) => Math.min(requestsMeta.last_page, p + 1))}
              ...
              leaveTypes.map((policy, i) => {
                ...
                return (
                  <GlassCard key={policy.id} className={`border-t-4 ${colors[i % colors.length]}`}>
                    <h4 className="text-sm font-black text-slate-900 dark:text-white uppercase tracking-tight mb-4">
                      {policy.name}
                    </h4>
                    <div className="space-y-3">
                      <div className="flex justify-between items-center text-[10px] font-bold">
                        ...
                        <span className="text-slate-900 dark:text-white">{policy.default_days_per_year} Days</span>
                      </div>
                      <div className="flex justify-between items-center text-[10px] font-bold">
                        <span className="text-slate-400 dark:text-slate-500 uppercase tracking-widest">
                          Accrual Method
                      ...
                      <button className="w-full pt-4 border-t border-slate-200 dark:border-white/5 text-[10px] font-black text-[#8252e9] uppercase tracking-widest hover:text-[#6b3ec7] dark:hover:text-white transition-colors">
                        View Policy Details
                      </button>
                    </div>
                  </GlassCard>
        ...
        {activeTab === 'Absence Tracking' && (
          <div className="space-y-6">
            <div className="text-center py-12 text-slate-400 dark:text-slate-500">
              ...
              <p className="text-lg font-bold text-slate-900 dark:text-white">Absence Tracking Coming Soon</p>
        ...
        {activeTab === 'Holiday Calendar' && (
          <div className="space-y-6">
            <div className="text-center py-12 text-slate-400 dark:text-slate-500">
              <div className="text-4xl mb-4">📅</div>
              <p className="text-lg font-bold text-slate-900 dark:text-white">Holiday Calendar Coming Soon</p>
              <p className="text-sm mt-2">
